...
<!-- CONTADO:INICIO -->
Contado solo el 30/8/2026. No editar a mano: lo reescribe
...
- **338 eventos aprobados** en la agenda y 91 sin aprobar (borradores IA y archivados).
...
- Search Console, semana del 22/8/2026 al 28/8/2026: **161 clics y 13.474 impresiones**. El grueso sigue entrando por fichas de agenda.
- YouTube: **47.931 visitas** y 292 suscriptores. Ojo: `STATS.vistasYouTube` en `app/lib/site.js` es un número aparte, escrito a mano, y es el que se publica en la web.
<!-- CONTADO:FIN -->
