...
<!-- CONTADO:INICIO -->
Contado solo el 23/9/2026. No editar a mano: lo reescribe
...
- **405 eventos aprobados** en la agenda y 59 sin aprobar (borradores IA y archivados).
...
- Search Console, semana del 15/9/2026 al 21/9/2026: **92 clics y 8.495 impresiones**. El grueso sigue entrando por fichas de agenda.
- YouTube: **59.690 visitas** y 314 suscriptores. Ojo: `STATS.vistasYouTube` en `app/lib/site.js` es un número aparte, escrito a mano, y es el que se publica en la web.
<!-- CONTADO:FIN -->
