...
<!-- CONTADO:INICIO -->
Contado solo el 10/9/2026. No editar a mano: lo reescribe
...
- Search Console, semana del 2/9/2026 al 8/9/2026: **142 clics y 14.916 impresiones**. El grueso sigue entrando por fichas de agenda.
- YouTube: **53.031 visitas** y 305 suscriptores. Ojo: `STATS.vistasYouTube` en `app/lib/site.js` es un número aparte, escrito a mano, y es el que se publica en la web.
<!-- CONTADO:FIN -->
