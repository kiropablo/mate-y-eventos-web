...
<!-- CONTADO:INICIO -->
Contado solo el 13/9/2026. No editar a mano: lo reescribe
...
- Search Console, semana del 5/9/2026 al 11/9/2026: **81 clics y 9.745 impresiones**. El grueso sigue entrando por fichas de agenda.
- YouTube: **56.858 visitas** y 308 suscriptores. Ojo: `STATS.vistasYouTube` en `app/lib/site.js` es un número aparte, escrito a mano, y es el que se publica en la web.
<!-- CONTADO:FIN -->
