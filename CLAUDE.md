...
<!-- CONTADO:INICIO -->
Contado solo el 9/9/2026. No editar a mano: lo reescribe
...
- Search Console, semana del 1/9/2026 al 7/9/2026: **137 clics y 14.521 impresiones**. El grueso sigue entrando por fichas de agenda.
- YouTube: **48.360 visitas** y 302 suscriptores. Ojo: `STATS.vistasYouTube` en `app/lib/site.js` es un número aparte, escrito a mano, y es el que se publica en la web.
<!-- CONTADO:FIN -->
