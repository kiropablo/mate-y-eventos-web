...
<!-- CONTADO:INICIO -->
Contado solo el 1/9/2026. No editar a mano: lo reescribe
...
- **338 eventos aprobados** en la agenda y 98 sin aprobar (borradores IA y archivados).
...
- Search Console, semana del 24/8/2026 al 30/8/2026: **136 clics y 12.326 impresiones**. El grueso sigue entrando por fichas de agenda.
- YouTube: **48.034 visitas** y 293 suscriptores. Ojo: `STATS.vistasYouTube` en `app/lib/site.js` es un número aparte, escrito a mano, y es el que se publica en la web.
<!-- CONTADO:FIN -->
