...
<!-- CONTADO:INICIO -->
Contado solo el 12/9/2026. No editar a mano: lo reescribe
...
- Search Console, semana del 4/9/2026 al 10/9/2026: **97 clics y 10.838 impresiones**. El grueso sigue entrando por fichas de agenda.
- YouTube: **55.806 visitas** y 308 suscriptores. Ojo: `STATS.vistasYouTube` en `app/lib/site.js` es un número aparte, escrito a mano, y es el que se publica en la web.
<!-- CONTADO:FIN -->
