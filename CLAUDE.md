...
<!-- CONTADO:INICIO -->
Contado solo el 16/9/2026. No editar a mano: lo reescribe
...
- Search Console, semana del 8/9/2026 al 14/9/2026: **39 clics y 6.548 impresiones**. El grueso sigue entrando por fichas de agenda.
- YouTube: **57.501 visitas** y 308 suscriptores. Ojo: `STATS.vistasYouTube` en `app/lib/site.js` es un número aparte, escrito a mano, y es el que se publica en la web.
<!-- CONTADO:FIN -->
