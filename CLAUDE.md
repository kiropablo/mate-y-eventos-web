...
<!-- CONTADO:INICIO -->
Contado solo el 2/9/2026. No editar a mano: lo reescribe
...
- **338 eventos aprobados** en la agenda y 100 sin aprobar (borradores IA y archivados).
- **10 eventos verificados** por su organizador.
- De los aprobados: 116 sin fecha anunciada y 10 argentinos sin provincia. **No son datos que falten cargar**: son eventos cuya fecha o sede todavía no se anunció, y completarlos sería inventar.
- Search Console, semana del 25/8/2026 al 31/8/2026: **139 clics y 11.208 impresiones**. El grueso sigue entrando por fichas de agenda.
- YouTube: **48.088 visitas** y 295 suscriptores. Ojo: `STATS.vistasYouTube` en `app/lib/site.js` es un número aparte, escrito a mano, y es el que se publica en la web.
<!-- CONTADO:FIN -->
