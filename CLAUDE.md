...
<!-- CONTADO:INICIO -->
Contado solo el 20/9/2026. No editar a mano: lo reescribe
...
- Search Console, semana del 12/9/2026 al 18/9/2026: **54 clics y 6.147 impresiones**. El grueso sigue entrando por fichas de agenda.
- YouTube: **58.970 visitas** y 302 suscriptores. Ojo: `STATS.vistasYouTube` en `app/lib/site.js` es un número aparte, escrito a mano, y es el que se publica en la web.
<!-- CONTADO:FIN -->
