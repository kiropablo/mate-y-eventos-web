...
:::checklist Antes de cerrar el menú de un evento
- Pensá en el invitado de mayor edad o menor tolerancia antes que en el más aventurero
- Si un plato sale mal en cocina, aislalo: nunca mezcles una porción fallada con una buena para "estirar"
- Usá la degustación para escuchar el evento completo, no solo para aprobar sabores
- Elegí sabores reconocibles con un giro, en vez de apostar todo a lo experimental
- Documentá qué no funcionó y por qué, para no repetir el mismo error dos veces
:::
