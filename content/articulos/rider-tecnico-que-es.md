...
:::checklist Cómo leer y negociar un rider técnico sin perder calidad
- Separá el rider en bloques por área (sonido, luces, video, hospitality) antes de cotizar nada
- Marcá qué requerimientos son innegociables y cuáles admiten alternativas de mercado
- Armá el contra-rider con propuestas concretas, no con negativas genéricas
- Confirmá cada cambio con el responsable técnico del artista, no solo con el tour manager
- Anticipale a las bandas soporte los tiempos y el espacio real antes del día del show
- Tratá los pedidos de hospitality con el mismo rigor que los técnicos: también son parte del contrato
:::
