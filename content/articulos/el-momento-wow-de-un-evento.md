...
:::checklist Antes de diseñar tu momento wow
- Definí primero qué mensaje o emoción del evento querés que ese instante represente, antes de elegir el recurso técnico
- Ubicá el momento en el punto del timing donde genere mayor contraste con lo que el público está esperando
- Armá una secuencia narrativa de principio a fin, no solo un efecto puntual sin contexto previo ni cierre
- Verificá que el recurso elegido (tecnología, performance, sorpresa) esté justificado por la historia y no al revés
- Observá la reacción espontánea del público durante el evento como primer indicador, antes de esperar las métricas de redes
:::
