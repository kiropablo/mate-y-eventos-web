...
:::checklist Para gestionar catering u operaciones de alta exigencia en eventos
- Fijá un límite de eventos simultáneos según la cantidad de gente calificada que realmente tenés disponible, no según la demanda que te llega
- Definí antes del evento qué elementos son innegociables para el cliente y comunicaselos al equipo, para que nadie necesite tu autorización en el momento del error
- Diseñá los protocolos internos (como la barrida pareja de platos) para que la calidad no dependa de quién está mirando
- Priorizá actitud y ganas de aprender por sobre experiencia previa al momento de sumar gente nueva al equipo
- Delegá funciones clave (compras, logística, producción) apenas la operación empiece a depender demasiado de una sola persona
- Calculá el costo de un imprevisto grave como parte del presupuesto de reputación, no como una pérdida excepcional
:::
