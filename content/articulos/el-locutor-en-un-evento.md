...
- Pedí el guion con tiempos claros y formato legible (interlineado amplio, tipografía sin cursiva)
- Reunite con el técnico de sonido antes que con nadie más y confirmá quién entrega el micrófono
- Averiguá quién viene entre los oradores, si alguno necesita acompañamiento o traducción, y quién tiende a extenderse
- Definí con el productor qué hacer si el público no vuelve del coffee o del almuerzo
- Armá el presupuesto relevando horas, idioma, vestimenta y distancia, no solo "cuánto cobrás por evento"
:::
