...
:::checklist Antes de contratar un artista o proveedor con marca fuerte
- Confirmá por escrito quién representa oficialmente al artista y qué porcentaje cobra cada intermediario
- Pedí hablar directo con quien decide, aunque haya un manager en el medio
- Preguntá qué condiciones técnicas y de calidad son innegociables antes de cerrar presupuesto
- Dejá asentado en el contrato quién define los cambios de último momento durante el montaje
- Evaluá si el sobrecosto que te cotizan corresponde a valor agregado o solo a cercanía con el contacto
:::
