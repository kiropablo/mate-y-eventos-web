...
:::checklist Los cinco puntos que todo coordinador de área debería tener resueltos antes del evento
- Mapear el área: de dónde recibe información, a quién responde y a quién lidera
- Identificar los puntos críticos de los que depende esa área (tiempo, seguridad, conectividad, según corresponda)
- Definir el protocolo de comunicación: qué se dice por handy, qué por WhatsApp y qué amerita un llamado directo
- Armar un checklist propio con horarios y verificaciones específicas del área
- Tener claro en qué momento hay que escalar un problema en vez de intentar resolverlo solo
:::
