...
:::checklist Condiciones técnicas para que un show interactivo funcione en un evento
- Ubicar el show en un momento del cronograma donde el público no esté disperso ni recién llegando
- Evitar escenarios elevados quandi se busca interacción directa: la distancia entre subir y bajar hace perder el foco de la sala
- Limitar la cantidad de público para formatos de interacción cercana, sobre todo en formato cóctel
- Definir de antemano si el público estará sentado en mesas o de pie, porque cambia por completo la estrategia de captación
- Relevar con el artista o proveedor a quién está dirigido el evento antes de definir el contenido del show
:::
