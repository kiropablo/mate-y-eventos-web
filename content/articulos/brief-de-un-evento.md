...
:::checklist Cómo leer un brief antes de cotizar
- Identificá primero qué tipo de pedido es: pliego rígido o brief abierto de marca
- Separá el tengo que del quiero qué antes de armar cualquier propuesta
- Buscá activamente el anhelo: preguntá por referencias de eventos que le gustaron al cliente
- Pedí un audio o una llamada corta cuando el documento escrito deje dudas
- Ordená el detalle técnico por espacios o por áreas, no como lista suelta
- Revisá cualquier brief redactado con IA como una versión más, nunca como la definitiva
:::
