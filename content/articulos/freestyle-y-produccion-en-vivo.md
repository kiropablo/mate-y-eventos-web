...
## Lo que pasa en una batalla no se puede grabar, solo se puede vivir
...
## Cuando el sonido falla, el evento necesita un plan B que el público ni note
...
:::checklist Qué necesita un show de improvisación en vivo para sostenerse
- Definir un sistema de respaldo visual (pantallas, timers, señas) para cuando el retorno de audio falla
- Dejar tramos del cronograma sin guion cerrado, para que lo imprevisto tenga dónde suceder
- Ubicar pantallas o referencias en múltiples puntos del escenario, no solo de frente al artista
- Coordinar con el técnico de sonido una señal de emergencia clara si el monitor se corta en pleno acto
- Preparar al talento con información de contexto (tiempo, público, reglas) antes de subir, no solo con el brief general del evento
:::

## Matías y Dozer: por qué todo artista necesita separar a la persona del personaje
...
### ¿Qué es una batalla de freestyle o "batalla de gallos" y cómo funciona el formato?
...
### ¿Por qué el retorno de audio es tan crítico para un artista de freestyle en un escenario en vivo?
...
### ¿Qué diferencia hay entre ver una batalla de freestyle en vivo y verla grabada en video?
...
### ¿Cómo se preparan los freestylers para competir si el contenido que van a decir es improvisado?
...
### ¿Por qué un artista de freestyle necesita un nombre artístico o "personaje" distinto de su identidad real?
...
### ¿Cómo afectó la pandemia al crecimiento de los eventos de freestyle y rap en vivo?
...
### ¿Por qué la espontaneidad se considera parte del espectáculo en un evento de improvisación en vivo?
