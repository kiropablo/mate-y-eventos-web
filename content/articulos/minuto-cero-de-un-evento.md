...
:::checklist Antes de que arranque el evento
- Identificá de antemano cuáles son los picos de tensión operativa reales, no solo la apertura
- Hacé la reunión de refuerzo de escena con margen (45 minutos antes), incluyendo a todos los operadores aunque su tarea parezca no relacionada
- Sumá una narrativa corta de repaso cinco minutos antes del arranque, con los pies de entrada exactos de cada área
- Detectá quién en el equipo está nervioso y acompañalo activamente, no asumas que "es una tarea simple"
- Definí un canal único de confirmación (por ejemplo, solo cabina técnica) para no saturar el handy con "okay" de todo el equipo
:::
