...
## Decirle que no a un cliente también es parte del servicio
...
## Los egos no se eliminan, se administran a favor del resultado
...
## El error no es una excepción, es parte del sistema
...
:::checklist Cómo aplicar estos criterios en la próxima producción
- Antes de decidir algo, formulá en voz alta la pregunta "¿esto lo necesita el evento?" y usala como criterio de corte en discusiones internas
- Identificá con el equipo, antes del evento, cuál es el eslabón más débil de la cadena y armá un plan para ese punto específico
- Si un cliente pide algo que perjudica el resultado, explicá el impacto concreto antes de ceder o de imponerte
- Detectá qué egos del equipo necesitan contención y cuáles necesitan reconocimiento, y actuá distinto en cada caso
- Reservá cinco minutos post evento para registrar qué falló y por qué, más allá de si se notó o no
:::
...
### ¿Qué significa exactamente la frase "el evento manda" en la producción de eventos?
...
### ¿Cómo se le dice que no a un cliente sin dañar la relación comercial?
...
### ¿Cuándo conviene ceder ante un pedido de un cliente aunque no sea la mejor decisión técnica?
...
### ¿Cómo se maneja el ego de un técnico o artista sin herir su profesionalismo?
...
### ¿Por qué es imposible eliminar por completo el error en la producción de un evento?
...
### ¿Qué significa que "un evento es un organismo vivo"?
...
### ¿Cómo se identifica el punto más débil de un evento antes de que ocurra?
