...
:::checklist Cómo incorporar diseño sensorial a un evento sin oscuridad total
- Definí un guion de efectos separado del guion de contenido, con tiempos exactos de entrada y salida de cada estímulo
- Si sumás sonido espacial, definí primero qué querés que el público sienta (cercanía, distancia, envolvente) antes de elegir la tecnología
- Antes de agregar un aroma o textura, preguntate si tiene un momento específico del evento donde cumple una función, no solo un lugar genérico
- Chequeá que los estímulos sensoriales no compitan entre sí: un recurso visual fuerte necesita un correlato sonoro coherente, no un agregado aislado
- Si el objetivo es transmitir una emoción del cliente, diseñá una situación que la genere en el público en vez de anunciarla en un discurso
:::
