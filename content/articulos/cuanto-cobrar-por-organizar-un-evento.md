...
episodioTitulo: "T02E20 | Cómo definir el precio de un evento sin regalar tu trabajo"
fecha: "2026-06-17"
eje: "Estrategia & Negocio"
etiquetas: ["presupuestos", "pricing", "negociación", "ventas", "freelance"]
slugsAnteriores: ["AJpzAobAKOU"]
lectura: 5
generado: "2026-07-22"
publicado: true
revisado: "2026-07-22"
...
:::checklist Antes de mandar un presupuesto
- Listá todos los componentes invisibles del servicio: horas de preproducción, riesgo, know-how, gastos fijos
- Definí si vas a bajar el precio por estrategia comercial puntual o si estás cediendo por miedo
- Prepará la reunión de presentación como una reunión de verdad, con objetivo claro, no como un trámite
- Si el cliente dice "es caro", preguntá primero si el problema es el valor percibido o el presupuesto disponible
- Abrí el presupuesto en partes cuando haga falta explicar por qué cuesta lo que cuesta
- Marcá un límite: si no hay margen para sostener la calidad, es información, no un fracaso
:::
