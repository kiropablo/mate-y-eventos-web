...
:::checklist Cómo planificar el timing musical de una fiesta social
- Relevar con los anfitriones el rango etario y el perfil musical de los invitados antes de armar cualquier tanda
- Dividir el tiempo total del evento en bloques claros: recepción, banda en vivo, shows, pico de pista, cierre
- Calcular el tamaño del espacio de baile en relación a la cantidad real de invitados, no a la capacidad máxima del salón
- Definir con el cliente los momentos no negociables (discursos, sorpresas, cotillón) antes de fijar el resto del cronograma
- Dejar margen de ajuste en cada bloque para poder estirar o acortar según la respuesta real del público
:::
