...
## La pregunta real de un CFO no es "cuánto cuesta" sino "comparado con qué"
...
## Tres KPIs bien elegidos valen más que veinte métricas sueltas
...
## El reporte post evento es el documento que decide si hay una próxima edición
...
:::checklist Cómo armar un reporte que defienda tu evento como inversión
- Definí antes del evento (no después) cuáles son los dos o tres KPIs que vas a reportar
- Registrá el costo total real, incluyendo tiempo y recursos internos, no solo lo pagado a proveedores
- Comparé lo obtenido contra lo esperado, no solo contra el evento anterior
- Incluí en el informe qué alternativa de inversión se descartó al elegir hacer el evento
- Sumá una recomendación concreta: repetir, ajustar formato o discontinuar
:::
...
### ¿Cómo saber si un evento corporativo fue realmente rentable o solo salió lindo?
...
### ¿Qué KPIs conviene medir en un evento de lanzamiento de producto?
...
### ¿Por qué un CFO tiende a recortar el presupuesto de eventos antes que el de otras áreas?
...
### ¿Qué es el costo de oportunidad aplicado a la decisión de hacer un evento?
...
### ¿Qué debe incluir un reporte post evento para justificar la inversión ante un cliente o directorio?
...
### ¿Cuántos KPIs conviene medir en un evento para no perder foco?
...
### ¿Qué diferencia hay entre medir asistencia y medir conversión en un evento?
