---
titulo: "Inteligencia artificial en eventos: lo que no reemplaza al productor"
...
:::checklist Cómo detectar un nicho de público desatendido antes de lanzar un evento nuevo
- Escuchá los reclamos que aparecen espontáneamente en redes antes de diseñar cualquier concepto
- Probá el formato en una escala chica y en un solo lugar antes de replicarlo en otras ciudades
- Definí el corte por hábitos y momento de vida, no solo por edad o por género musical
- Ajustá horarios y duración al ritmo real de esa audiencia, no al estándar del rubro
- Repetí el formato en distintas plazas para confirmar que la demanda no era un fenómeno aislado
:::
