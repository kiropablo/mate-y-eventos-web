...
## Ninguna persona debería sostener sola varias tareas críticas al mismo tiempo
...
## La comunicación también se agota, y por eso necesita un protocolo
...
:::checklist Cómo bajar el burnout sin bajar el estándar
- Definí turnos reales con horarios de descanso y comida antes de que arranque el armado, no cuando alguien ya está agotado
- Identificá quién concentra más de una tarea crítica y asignale un foco principal y funciones secundarias claras
- Marcá los picos de carga en el timing de armado y ubicá los descansos justo antes de esos momentos
- Establecé quién habla por handy, sobre qué temas, y qué situaciones se resuelven por otro canal
- Reservá 15 minutos de debrief al cierre de cada jornada, no solo al final del evento completo
:::

## El debrief es lo que evita que el desgaste se acumule evento tras evento
...
### ¿Qué es el burnout en la industria de eventos y cómo se manifiesta durante la producción?
...
### ¿Cuáles son las señales más comunes de que un miembro del equipo está quemado durante el armado de un evento?
...
### ¿Cómo se puede prevenir el burnout del equipo antes de que empiece el evento?
...
### ¿Qué rol cumple un protocolo de comunicación por handy para reducir el desgaste del equipo?
...
### ¿Por qué es importante hacer un debrief después de un evento, aunque haya salido bien?
...
### ¿Cómo afecta el estado de ánimo de un líder al rendimiento del resto del equipo durante un evento?
...
### ¿Qué diferencia hay entre pedirle a alguien que "aguante" y diseñar turnos de descanso reales en un evento?
