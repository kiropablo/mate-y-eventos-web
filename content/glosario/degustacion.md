---
termino: "Degustación"
alias: ["degustación de menú", "prueba de platos"]
definicionCorta: "La instancia previa al evento donde el cliente prueba en persona los platos y bocados que se van a servir, generalmente antes de casamientos o eventos corporativos grandes."
episodio: "gNbnmeCtvPg"
episodioTitulo: "T01E11 - Edición Especial - De la cocina a los eventos - Parte 2"
minuto: ""
...
Para los organizadores y coordinadores que acompañan al cliente en este proceso —aunque no sean del rubro gastronómico—, la degustación es clave para entender matices del evento que no salen a la luz en una reunión común, y por eso se remarca como un momento estratégico dentro de la producción, no solo un trámite de cocina.
