---
termino: "Speaker"
alias: ["orador", "expositor"]
definicionCorta: "La persona que sube al escenario a dar una charla, presentación o exposición dentro de un evento, ya sea un especialista, un científico, un ejecutivo o una autoridad."
...
También se señala un problema típico de producción: speakers que llegan con su presentación a último momento, incluso en un pendrive minutos antes de subir, pese a que se les pidió el material con anticipación. Y se remarca la importancia de avisarles con claridad cuánto tiempo tienen, porque el control del timing (a veces con un cartel de cuenta regresiva o un cero en rojo) es una de las cosas que más los descoloca si no están preparados para eso.
