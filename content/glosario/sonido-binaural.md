---
termino: "Sonido binaural"
alias: ["audio binaural", "tecnología binaural"]
definicionCorta: "Es una técnica de grabación y reproducción de audio, pensada para escucharse con auriculares, que le da al sonido profundidad, altura y espacialidad, generando una sensación envolvente muy distinta a la de una mezcla estéreo convencional."
...
Como alternativa o complemento, también se puede trabajar el sonido espacial con parlantes distribuidos físicamente en el espacio (por ejemplo, en el techo de una sala), variando la cantidad según el tamaño del evento y las posibilidades del lugar donde se monte.
