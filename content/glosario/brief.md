---
termino: "Brief"
alias: ["pedido", "brief del cliente"]
definicionCorta: "El documento que entrega quien solicita un evento (cliente, agencia, empresa u organismo público) detallando qué necesita. La palabra viene de \"breve\", aunque en la práctica muchas veces termina siendo todo menos breve."
episodio: "ErJZUxUw4mo"
episodioTitulo: "T01E06 - El Brief y el Arte de Pedir un Evento"
minuto: ""
...
En el episodio se propone armar un buen brief con: contexto (cuándo, dónde, en qué instancia), objetivos claros del evento, y el detalle de requerimientos ordenado de forma lógica (por espacio o por área de servicio). Cuanto más claro sea ese pedido, más alineada va a estar la propuesta que se arma en respuesta, y menos tiempo se pierde en idas y vueltas después.
